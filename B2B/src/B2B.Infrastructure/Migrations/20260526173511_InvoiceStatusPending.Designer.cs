...
namespace B2B.Infrastructure.Migrations
{
    ...
    [Migration("20260526173511_InvoiceStatusPending")]
    partial class InvoiceStatusPending
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("B2B.Domain.Invoices.Invoice", b =>
                {
                    ...
                    b.ToTable("invoices", null, t =>
                        {
                            t.HasCheckConstraint("ck_invoices_accepted_at_consistency", "(status = 'Pending' AND accepted_at IS NULL) OR (status <> 'Pending')");
                        });
                });
